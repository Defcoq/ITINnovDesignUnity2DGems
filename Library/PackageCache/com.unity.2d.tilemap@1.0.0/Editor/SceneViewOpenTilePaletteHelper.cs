...
namespace UnityEditor.Tilemaps
{
    internal class SceneViewOpenTilePaletteHelper : ScriptableSingleton<SceneViewOpenTilePaletteHelper>
    {
        ...
        private void OnSceneViewDisplayGUI()
        {
        ...
        class Overlay : TransientSceneViewOverlay
        {
            const string k_OverlayID = "Scene View/Tilemap Palette Helper";
            const string k_DisplayName = "Tile Palette";
            public override bool visible => showInSceneViewActive && IsActive();

            public override void OnGUI()
            {
                instance.OnSceneViewDisplayGUI();
            }
        }
    }
}
